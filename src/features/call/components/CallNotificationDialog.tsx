...
type CallNotificationDialogProps = {
  
  callerData:incomingCallType,
   onAccept:()=>void, 
   onReject:()=>void, 
   onIgnore: ()=>void,
}

const CallNotificationDialog = ({ callerData, onAccept, onReject, onIgnore }:CallNotificationDialogProps) => {
  return (
